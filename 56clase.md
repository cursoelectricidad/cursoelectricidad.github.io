...
[https://www.youtube.com/embed/OOucZiR9osE](https://www.youtube.com/embed/OOucZiR9osE)
...
* **Organización en trabajos prácticos:**
  ...
  * Mantener un método común para evitar confusiones en el trazado y montaje de cañerías.
...
* **Objetivo del ejercicio:**
  ...
  * Trazar en conjunto la cañería en el plano para practicar **tipos de caños**, **cantidad de conductores** y **aplicación de normativa**.
...
* Dentro de cada tramo, se anota la **cantidad y sección de conductores** (ej.: `2×1,5 + 2×2,5 + T`).
...
* Lo ideal:
  ...
  1. Llevar los conductores por la cañería más directa posible.

  2. Usar cajas grandes para empalmes y distribución de circuitos.
...
* Antes de empezar, calcular **metros de conductor por color**:
  ...
  * Ejemplo: 200 m de fase, 100 m de neutro, 50 m de tierra.
...
#### 1. **Normas Generales de Canalización y Curvas**
   - Máximo de **3 curvas** entre cajas, bocas o gabinetes. Lo ideal son **2 curvas no consecutivas** para facilitar el paso de cables y cintas.
   - Si hay más de 3 curvas, se complica el avance de cables; deja espacio para maniobrar o usa técnicas como "pescar" cables.
   - Todas las canalizaciones (cañerías, cable canal) deben ser consistentes en material (ej.: todo PVC o todo corrugado) y medida a lo largo del sistema.
   - Cambios de material solo en cajas de paso, conexión o transición. No en medio de la cañería.
   - Toda cañería debe terminar en una boca, caja, gabinete o elemento de transición. No se permiten uniones dentro de la cañería; todas en cajas.
   - En circuitos fijos, las conexiones van hasta la caja del equipo.


#### 2. **Circuitos y Separación**
   - **Circuitos independientes**: Iluminación por un lado (conductores de 1,5 mm²) y tomas/corriente por otro (2,5 mm²), más conductor de tierra en ambos.
   - Evitar **circuitos mixtos** (iluminación + tomas en el mismo circuito). En el ejemplo, se usan dos circuitos monofásicos: C1 (iluminación) y C2 (tomas).
   - Máximo **3 circuitos monofásicos** por cañería (según normas).
   - En ventiladores: Usar 1,5 mm² como en iluminación, con fase, neutro y retornos adicionales según encendido.
   - Conductor de protección (tierra): Obligatorio. Las canalizaciones metálicas **no sustituyen** al conductor de tierra, pero ayudan como complemento si están conectadas a tierra.


#### 3. **Cajas y Elementos de Maniobra**
   - Interruptores, magnéticos, diferenciales deben ir en cajas (tableros). Protegidos contra contacto accidental.
   - Tipos de cajas:
     - **Octogonal** para iluminación y ventiladores (ej.: 5x5 o más grande si hay múltiples retornos).
     - **Rectangular** (ej.: 10x10) para tomas y pasos.
   - Alturas típicas: Llaves a 1,10-1,20 m; tomas a 0,30-0,40 m; ventiladores en techo.
   - En aulas o espacios con niños: Llaves más altas para evitar manipulación.
   - Uniones y derivaciones solo en cajas accesibles y visibles. No ocultas.


#### 4. **Planificación y Trazado de Canalizaciones**
   - Siempre por arriba (cielo raso) para minimizar esfuerzo y curvas; bajar solo en paredes con curvas de 90°.
   - Ruta más corta y económica: Evitar entrecruzamientos; usar diagonales si es posible.
   - En octogonales (8 caras): Facilita salidas en cualquier dirección, reduciendo curvas.
   - Máximo 2-3 curvas por tramo; si se necesita derivar, usar "S" o conectores.
   - Diámetros de cañería: Basado en tablas (ej.: 3/4" para hasta 6 conductores). Usar mínimo requerido, pero con margen.
   - En el plano: Marcar cañerías con diámetro arriba (ej.: 3/4) y conductores abajo (ej.: 2x1,5 + T).


#### 5. **Conductores y Colores**
   - Tamaños: 1,5 mm² para iluminación/ventiladores; 2,5 mm² para tomas. Tierra: Misma sección o menor (T mayúscula para suma de tierras).
   - Colores: Neutro (azul), fase/retornos (rojo, negro o marrón). Diferenciar para evitar confusiones.
   - Cálculo por tramos: Medir cañería, agregar 15 cm de sobrante por conexión. Multiplicar por número de conductores.
   - No cortar cables innecesariamente; agregar retornos progresivamente. En obra: Pasar cinta, agregar cables por tramos.


#### 6. **Práctica en Obra y Errores Comunes**
   - Procedimiento: Ubicar bocas primero, trazar cañerías, fijarlas, pasar cables (de extremo a extremo, agregando en cajas).
   - Evitar: Uniones en cañerías, circuitos mixtos, sustituir tierra con metálico, más de 3 curvas consecutivas.
   - En planos: Redondear medidas hacia arriba para sobrantes. Escala: Ajustar por impresión (ej.: 4,70x7,60 m internas).
   - Presupuestos: Por boca (ej.: 40-42.000 pesos por boca embutida, incluyendo picado, cañería, cableado). Detallar: Extracción, recableado, movilidad.
   - Errores vistos: Cobrar "revisión" sin detalles, replanteos innecesarios, cañerías independientes por circuito (innecesario si caben 3 por caño).


#### 7. **Presupuestos y Cobros**
   - Detallar por ítem: Bocas (iluminación: 7-9 en ejemplo), curvas, cañerías, conductores. Valores aproximados: Jornal oficial (31-33.000 pesos/8h), reparación mínima (10-15.000 pesos).
   - Evitar montos generales; especificar cantidades (ej.: recableado incluye sacar viejo + nuevo).
   - Lista de materiales: Basada en tramos (cañerías, curvas, cuplas, cables por color y metro).
