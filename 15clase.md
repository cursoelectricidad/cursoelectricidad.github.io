...
* Solo se dictan lunes, martes y miércoles; no hay cursos jueves ni viernes.
* Alta tasa de abandono: de 40 inscriptos, suelen terminar solo unos 12.
* Algunos cursos se cancelaron por baja demanda o problemas (ej. carpintería tradicional, cerrajería).
* Se priorizan cursos con rápida salida laboral (ej. refrigeración, aire acondicionado).

**Equipamiento y materiales en clase**

* No hay proyector ni televisor disponible, lo que dificulta mostrar material.
* El profesor intenta conseguir catálogos y fotos para la enseñanza.
* Muestra perfiles para sistema de Durlock y explica su uso en divisorias con canalizaciones.

**Explicación técnica sobre acometidas**

* Diferencia entre instalación aérea y subterránea:

  * **Aérea** → 2 caños: uno de entrada y otro de salida.
  * **Subterránea** → 1 solo caño.
* Uso de **pipeta** para proteger el cable y evitar ingreso de agua de lluvia.
* Instalación correcta del conductor preensamblado:
  ...
  * Bajada inclinada antes de entrar para evitar acumulación de agua.

**Ventajas del conductor preensamblado**

* Mayor capacidad de corriente:

  * 2x6 mm² → soporta 54 A (casi el doble que un cable bipolar de igual sección).
* Puede usarse tanto para acometidas aéreas como subterráneas.
* Antes se usaban dos unipolares con aislador, menos eficientes y resistentes.

**Instalación de alarmas**

* Detectores infrarrojos a **2,20 m de altura** (nunca más bajo que el marco de la puerta).
* Colocar en diagonal para evitar puntos ciegos y cubrir ventanas.
* Cableado oculto (UTP o telefónico) para estética y seguridad.

**Práctica con Durlock**

* Se planea construir una pared pequeña (1×1 m) para practicar:

  * Montaje de perfiles verticales y travesaños.
  * Integración de canalizaciones para luz o agua.
  * Colocación de cajas eléctricas dentro de la estructura.
...
* La forma más segura es **anclar a la estructura metálica interna** antes de cerrar la pared.
* Procedimiento:

  1. Se coloca una placa de un lado dejando la estructura visible por el otro.
  2. Se fija la caja o soporte al perfil metálico con tijera cortachapa.
  3. Se realiza la canalización hacia arriba o lateral según diseño.
  4. Luego se coloca la segunda placa haciendo la mueca para la caja.
* En cielorrasos suspendidos, las bocas se fijan a los perfiles para que queden firmes y ocultas.

**Conductor preensamblado**

* En acometida aérea va **desde la línea de distribución hasta el medidor**, sin cortes intermedios para no perder capacidad de corriente.
* Se conecta mediante **morcetos** (uno para fase y otro para neutro), que perforan la aislación para hacer contacto sin pelar el cable.
...
* Incluye todo el conjunto desde la línea hasta el medidor: cable, morceto, pinza de anclaje y accesorios.
* En acometida aérea, el preensamblado sube por caño, pasa por pipeta inclinada para evitar entrada de agua, y se ancla antes de ingresar al edificio.

**Medición de puesta a tierra**

* **Instrumento ideal**: megómetro.
* **Método alternativo**: medir tensión entre fase–tierra y fase–neutro; valores similares indican buena tierra (no muy preciso).
* Limitación: con tester sin carga puede dar 220 V, pero con consumo (ej. lámpara LED) puede bajar mucho si la tierra es deficiente.
* Método tradicional: usar un foco incandescente de 100 W para probar.
...
* El método práctico es usar un foco incandescente, no solo un tester.
* Ejemplo: un foco de **100 W** consume aprox. **0,5 A**; si no enciende bien, la tierra es deficiente.
* Para una prueba más exigente, se puede usar más carga.

**2. Multímetro vs pinza amperométrica**

* El **multímetro** (o tester) sirve para electricidad y electrónica, mide tensión, corriente (en serie), resistencia, capacitancia (en algunos modelos).
* La **pinza amperométrica** mide corriente sin cortar el circuito, solo abrazando un conductor (fase o neutro, no ambos juntos).
* Hay modelos que también miden capacitores.
* La pinza es más común en electricidad industrial; el multímetro, en electrónica.
* Al medir capacitores:

  1. Deben estar descargados.
  2. Deben estar desconectados del circuito.

**3. Cañerías y accesorios en instalaciones eléctricas**

* **Tubos rígidos de PVC**: vienen en diámetros comunes (16, 20, 22, 25 mm, etc.).
* Clasificación: liviano, semipesado, pesado.
* Resisten generalmente hasta 60 °C (según norma IRAM).
* Se elige el diámetro según cantidad de conductores y circuitos (hay tablas).
* **Curvado**:
...
* **Cajas**:
  ...
  * Estanco (para exteriores, con burlete y sin perforaciones de fábrica).
* **Accesorios**: cuplas, conectores, curvas, pegamento especial para unir PVC.

**4. Fijación de cajas**

* Las cajas deben quedar firmes; no moverse ni hacia arriba ni lateralmente.
* El inspector revisa golpeando con un palo (incluso si el cielorraso ya está cerrado).
* Si no se fijan bien, los cables pueden quedar colgando o rozando.

**5. Distribución de circuitos**

* Se pueden pasar hasta **3 circuitos por cañería**.
* Ejemplo: por una misma bajada se puede llevar iluminación, tomas y un circuito especial, siempre que el dimensionamiento sea correcto.
* En sobremesadas de cocina se suelen colocar varias bocas (tomas) y un circuito para aire acondicionado.

**6. Presupuesto y materiales**

* Hacer lista de materiales primero.
* Consultar precios (por ejemplo, en ElectroMisiones) para estimar el costo de materiales; la mano de obra es aparte.
...
* Las tomas o puntos de conexión para espejos con luz deben planificarse según la estética y el uso (ocultas detrás del espejo o visibles arriba).
* Las decisiones dependen del proyectista y del cliente, pero un punto de alimentación bien ubicado puede servir para varios elementos evitando instalar de más.

**2. Tipos de gabinetes eléctricos**

* **Metálicos**: pueden tener frente de vidrio para ver el estado de los interruptores sin abrir.
* **Plásticos (PVC)**: más comunes en viviendas, opacos y livianos.

**3. Identificación de circuitos en planos**

* Colores diferentes en planos ayudan a diferenciar:

  * Rojo → portero eléctrico.
  * Verde → tomacorrientes.
  * Otro color → iluminación.

**4. Tipos de caño y uso**

* **Extrapresado**: para embutir en hormigón.
* **Semipesado**: para ladrillo hueco.
* El trabajo prolijo requiere ranuras precisas (con amoladora), evitando romper el caño.

**5. Fijación de cañerías y cajas**

* **Grapa de sujeción**: diámetro 6 o 8 mm, se coloca con tornillo (mejor con tarugo que sin él).
* En ladrillo hueco: usar tarugos especiales que se expanden abrazando el ladrillo.

  * Algunos artesanales se refuerzan con alambre en la punta para que se abran como tope.
* En casos especiales se pueden usar anclajes químicos.

**6. Recomendaciones de instalación**

* En paredes terminadas, elegir sistemas de fijación adecuados para que no queden flojos.
* El reglamento exige que los caños queden bien sujetos para evitar deformaciones y garantizar seguridad.

**7. Pipeta y entrada de acometida**

* La pipeta evita que el agua que corre por el conductor entre a la vivienda.
* El cable debe formar un **bucle** antes de entrar para que el agua gotee fuera.
* Se usa **pinza de anclaje** para fijar el preensamblado, ya que es rígido.
* Si la pared es gruesa (20 cm), se puede acoplar un caño más grande hasta la caja de paso y luego bajar con conductores unipolares.
...
* La teoría de la facultad es solo la base; en obra surgen problemas reales que requieren criterio para decidir la mejor solución.
* Observar cómo trabaja un instalador experimentado ayuda a aprender a distinguir un trabajo bien hecho de uno incorrecto.

---

### **2. Fijaciones para cables y caños exteriores**

* **Pitones** (ganchos cerrados) y **ganchos en U**: se usan para fijar cables (por ejemplo, TV por cable) en la pared.
* El cable se coloca formando una **V invertida** antes de entrar a la vivienda para que el agua gotee y no ingrese.
* En instalaciones embutidas, se utiliza **mezcla** para fijar caños; las **grampas** se usan solo en instalaciones exteriores.
* Existen sistemas de sujeción más firmes para evitar que el caño se mueva si se apoya algo sobre él.

---

### **3. Caños para acometida**

* Uso de **caño PVC de doble aislación con refuerzo metálico interno**:

  * Sustituye al galvanizado.
  * Resiste deformaciones por calor o peso (el cable preensamblado es pesado).
* Medidas: 50 mm (2 pulgadas).

---

### **4. Configuración de acometida y medidor**

* Gabinete de medidores con caños y **pipeta** arriba para entrada aérea.
* La **puesta a tierra** puede ir con bornera en gabinetes plásticos.
* Si la acometida es subterránea, el conductor de tierra va junto al de alimentación.
* La **jabalina** del medidor y la del tablero seccional deben estar unidas para igualar potenciales.
* Si la distancia es grande, se puede colocar otra jabalina en el seccional, siempre unida a la primera.

---

### **5. Errores comunes**

* Tomar energía directamente desde el medidor para alimentar artefactos de gran consumo (ducha eléctrica, aire acondicionado) sin pasar por el tablero general → deja sin protección adecuada esos circuitos.

---

### **6. Cajas y medición de puesta a tierra**

* **Caja de inspección**: permite conectar el estelurímetro para medir la resistencia de puesta a tierra.
* Cada conductor desde el medidor hasta un departamento debe ir por su propio caño, con fase, neutro y tierra.

---

### **7. Instalaciones en edificios**

* Gabinetes modernos tienen interruptores arriba de cada medidor, identificados por unidad (Depto 1, 2, 3…).
* No se permite compartir conductores de alimentación entre departamentos.
...
* **Monofásico:** 2 fases (o 1 fase + neutro), más tierra → 3 conductores.
* **Trifásico:** 3 fases + neutro + tierra → 5 conductores.

---

**2. Módulos y selección de gabinetes**

* Cada “boca” o módulo corresponde a un espacio para interruptores (térmicas, diferenciales, etc.).
* Un interruptor **bipolar** ocupa **2 módulos**.
* La suma de todos los módulos necesarios define el tamaño del tablero.
* Ejemplo: Si tengo 8 circuitos monofásicos bipolares → 16 módulos.
* Se debe elegir un gabinete con capacidad **superior o igual** al número calculado (mejor si sobra un poco para futuras ampliaciones).

---

**3. Ubicación y practicidad**

* En el tablero detrás del medidor se recomienda más espacio (4 o 6 módulos mínimo) para maniobrar cómodamente.
* Se puede dividir cargas en varios tableros (ej.: uno solo para aires acondicionados).

---

**4. Cajas y reglamentación**

* Existen cajas seccionales, cajas de toma, gabinetes principales.
* Cada una tiene códigos y especificaciones, útiles para pedir materiales sin errores.
* Catálogos como Genrod o TubicElectric incluyen estas características.
...
* Los caños PVC modernos resisten hasta 90 °C antes de deformarse, permitiendo reemplazar caños de hierro en ciertos casos.

---

**6. Esquema básico de instalación**

* Desde la red pública hasta el medidor (acometida) → reglamentación de la distribuidora.
* Desde el medidor hacia la instalación interna → reglamentación AEA.
* El esquema unifilar representa fase y neutro, con tierra y dispositivos de protección.

---

**7. Reglamentación y modernización**

* EMSA (cooperativa/proveedora) adaptó o alineó la reglamentación para permitir nuevos productos normalizados.
...
* Todo tablero principal debe tener **símbolo de riesgo eléctrico** visible.
* Altura mínima del símbolo: 40 mm; letras de 10 mm sobre fondo amarillo.
...
* **Lugares secos**, de **fácil acceso** y **alejados** de instalaciones de gas, agua u otros elementos peligrosos.
* **Prohibido** instalar dentro de muebles, bajo mesadas, ni en interiores de piscinas o zonas muy húmedas.
* En exteriores o lugares polvorientos/húmedos, usar gabinetes con **grado de protección IP** adecuado.
* Evitar zonas donde pueda acumularse agua. Si hay riesgo, prever **desagüe en el gabinete**.
* En construcciones con subsuelo, considerar pendientes para drenar filtraciones.

---

### **2. Protección y seguridad**

* Ante inundaciones: **cortar energía** en el tablero general antes de que el agua alcance equipos eléctricos.
* Recintos con tableros deben tener:

  * **Iluminación artificial** mínima: 200 lux a 1 metro del piso (aprox. 500 lúmenes en iluminación práctica).
  * **Iluminación de emergencia** en lugares de alto tránsito o edificios.
  * Piso **sin desniveles** para evitar accidentes.
  * Acceso **despejado**, sin muebles ni obstáculos delante.
* En lugares húmedos persistentes (cisternas, bombas, etc.), preferir gabinetes de PVC para evitar oxidación.

---

### **3. Organización de tableros**

* **Tablero principal**: ubicado junto al medidor, recibe la acometida.
* **Tableros seccionales**: mínimo uno por piso (en dúplex, triplex, edificios, etc.).

  * Cada seccional controla y protege los circuitos de su planta.
  * Alimentación: lo más común es que el tablero principal alimente a los seccionales.
* **PSI** = Tableros Seccionales Independientes (pueden estar en zonas como quinchos o anexos).

---

### **4. Ergonomía y acceso**

* Puerta del tablero debe abrir con facilidad y permitir acceso seguro a los interruptores.
* Altura, ventilación y distancias mínimas según reglamentación AEA.
* Símbolos y cartelería de advertencia (riesgo eléctrico) visibles.

---

### **5. Apoyo gráfico y esquemas**

* Siempre usar esquemas unifilares para representar:

  * Tablero principal
  * Tableros seccionales
  * Distribución de circuitos
* Facilitan la comprensión de la reglamentación y evitan errores en obra.
...
###### Transcripción.    
Había menos alumnos porque el profesor mandó que no había clases ese día.    
    
Yo: Acá solo hay lunes, martes y miércoles.    
Sebastián: Acá nosotros sí.    
Yo: Pero los otros también, solo 3 días. Yo pregunté si había otros cursos otros días y dijieron que no.    
Sebastián: Capaz aglutinan todo.    
Juan Cardoso: Solo a la tarde no más, ¿no tienen tienen de mañana así cursos? Solo a la tarde nada más, a partir de las 6.    
ija en el caño **ahora ya no es garbanizado sino mitad garbanizado y después tiene paredes de PVC en los dos lados** pongo un anclaje acá y pongo el otro anclaje allá, entonces tengo el preensamblado y recién después entro acá en la pipeta. Esa pipeta vamos a suponer que esta es la entrada de tu casa vaya afuera, esto está disminuido nada más, pero la pipeta es así recta de 1 pulgada y media más o menos, debo tener por ahí como no vino mi ayudante entonces **esto es lo que entra**     
Gustavo Barrientos: Va en agua o no? Puede entrar en el agua?    
Profesor: Sí es el doble de esto más o menos, tiene que entrar por acá y después sale el caño para adentro y tiene que estar más o menos con una no tan recto cuando pasa acá sino un poco inclinado porque cuando uno hace el **anclaje el conductor tiene que hacer por lo menos una bajadita y después entra en la curva**.    
Torres: Por la lluvia?    
Profesor: Sí, por la lluvia, por el agua. Entonces para que no entre el agua también, eso es para que ustedes vayan viendo, si yo encuentro después unas pipetas, antes estaba todo ordenado hoy está un despelote ahí dentro entonces no se puede conseguir nada de lo que uno quiere.    
###### La pipeta se usa para proteger el cable y para proteger del agua de la lluvia.    
Torres: Yo le había comentado que tenía **ese más chico la medida entonces el electricista le rompió un poco ahí la curvita para que entre el cable del pilar**.    
Profesor: Si hace todas esas cosas... Yo no me río.    
Torres: Después le voy a mandar una foto.    
Ayudante: Yo no quiero saber que pasó.    
Torres: Él le pico así con la pinza, se ve que le rompió un poquito.    
###### Nosotros tenemos 4x4 (o 4x6) trifásica porque teníamos un aire trifásico. Los cables para trifásica ya están ahí arriba, siempre hay 4 cables más 1 que es el alumbrado público.    
Profesor: después le voy a mandar esta foto para que ustedes vean, **el conductor preensamblado hasta que corriente máxima soporta, acá vamos a suponer entrada de 2x6 o 2x10, el de 2x6 la corriente máxima que soporta es 54 amper.** si yo pongo un conductor de 6 milímetros o bipolar ese y me aguanta 30 casi el doble, por eso es interesante que ustedes vean las ventajas que tiene el preensamblado y el subterráneo con respecto al bipolar en las acometidas, por eso es que antes se hacían los 2 conductores unipolares eso que entraban ustedes y ya había un aislador soporte ahí arriba y después bajaba todo por bipolar tenía 2 grandes problemas:    
1. Directamente esos conductores necesitan un caño o algo parecido para que el conductor no esté a la interperie (no sirve para exterior).    
###### Instalación de alarmas a 2,20 de altura, nunca más bajo de la puerta, a 90 grados lo ideal es poner siempre en un lugar diagonal.    
2. Fíjense la corriente máxima que soporte. **RETENAX es la marca, preensamblado es el conductor**, o sea el conductor preensamblado subterráneo tiene esas condiciones que me permiten a mi hacer la cometida ya sea aérea o subterránea, esas cosas son importantes en el sentido de que ahí empieza mi instalación, de la entrada. Si tengo un buen conductor de entrada y un buen conductor ya sea en forma aérea o subterránea tengo la posibilidad que nosotros instaladores a partir del medidor hagamos una buena instalación. Por eso les hablo de esa curva recta, había una curva más grande ya que estamos ustedes dirán para que usa esto. Antes se usaba mucho para telefonía pero más de 7/8 pero antes de que se pierda, hay una parte que trabajamos con circuitos de baja tensión y una cosa importante que está en **auge es el tema de instalación de alarma de seguridad, y después contra incendios, generalmente se hacen más alarmas de seguridad**, siempre hay detectores infrarojos o de movimiento **esos infrarojos tienen la particularidad de que tienen que estar en una determinada altura si yo tengo la puerta que es de 2 metros esto debe estar a 2,20 NUNCA MÁS BAJO DE LA PUERTA.** Esto 2,20 arriba, y generalmente **el detector de movimiento si tiene un ángulo de 90 grados si yo coloco acá siempre mi barrido a 90 grados, pongo acá y tengo que barrer acá, si pongo un soporte y las ventanas son mi punto débil tengo que poner así** y acá yo tengo un punto ciego, lo ideal es poner siempre en un lugar diagonal. Se trata de que ese conductor en ese caso puede ser cable telefónico, ahora vienen los cables de UTP también puede ser así que no hay problema. Pero no se tienen que ver, entonces esto va hundido y **lo único que se ve en las instalaciones será un agujerico acá**, y arriba después va el detector de movimiento. Luego vamos a verlo, quería aprovechar porque esto se pierde.    
    
###### Pared 1 metro x 1 metro. Divisoria de durlock, perfilería.    
Si yo tengo algún día le pedí a ellos que me hagan una pared aunque sea de 1 metro x 1 metro pero a veces no tienen materiales hacen cositas chiquitas pero lo ideal acá: Este es una parte de un perfil, y acá viene otra parte del perfil vamos a suponer para hacer una pared, parecida a esta acá. Después vienen los travesaños y algunos perfiles ya tienen el hueco directamente para que pase la canalización ya sea agua luz o lo que sea. **Nosotros entramos nosotros a jugar en los perfiles que van en forma transversal, ahí colocamos la cajita**, la idea es que me hagan la pared y vean como se hace una **divisoria de durlock**, y se hace la instalación eléctrica, entonces vamos a poner de este lado.    
    
Maru: Eso para que se cumpla de que esté fijo?    
...
Maru: pero va de la bajada que va del...    
Ayudante: desde la línea hasta el pilar.     
Maru: en el medio quedaría el conductor preensamblado de la línea al pilar?    
Ayudante: todo, hasta el medidor.    
Profesor: Hasta el medidor, no se tiene que cortar porque sino pierde la característica de 60 y pico amper o lo que sea, pierde la característica.    
Maru: o sea **el conductor preensamblado va desde la línea hasta el medidor sigue todo hasta el medidor**.    
Profesor: Hasta el medidor, esa es la entrada del medidor.    
Gustavo Barrientos: Toce.    
Profesor: A la pucha, yo pensé que era un perro.    
Maru: estaba queriendo aguantar.    
Profesor: No, no hay problema. **El preensamblado y como se conecta arriba con el morceto, un morceto eso vamos a tener que hacer acá para que vean después entonces no hablamos tanto**.     
Torres: Y ahí en este está puesto.    
###### Definición acometida:     
Profesor: si lo que pasa es que es distinto el dibujo con respecto a la forma. Esa es la entrada que se llama acometida: **todo lo que constituye el cable el morceto la pinza de anclaje y todo el sistema hasta el medidor se llama acometida**, la acometida no es solo el cable, sino todo el complemento, todo lo que forma la alimentación, pero como te estaba comentando que si tengo que hacer la alimentación aérea salgo de ahí del medidor voy al tablero general y **después vuelvo otra vez subo por el caño y voy con sistema preensamblado y voy a mi edificio, ahí es donde entro con la pipeta esa. Ahí entra en la pipeta con la pinza de anclaje hago ese aro para que en caso de que el agua no entre allá, digo esto porque hay veces que uno va a la instalación y lo 1ero que ve en el tablero es que está mojado**.    
    
Ayudante: Esto es un morceto.    
Profesor: Mostrale el cable también ya que estás, este va a aprobar seguro.    
Ayudante: Esto es preensamblado, **esto va en la línea general más grande por supuesto este se abre, esto tiene unos dientes acá dentro y muerde primero el NEUTRO.** Esta es la línea, esta va a ser la línea general y este va del otro lado.     
Profesor: Tiene tipo un diente que muerde eso y se ajusta a través del tornillo que está arriba, ese tornillo está aislado no es que tiene energía se puede tocar con una pinza.    
Ayudante: Este se puede tocar con la mano(tornillo aislado) (no recomendado igual) y así queda mordido y este sería lo que va hasta tu pilar hasta tu medidor.    
Maru: y el otro va a la línea?    
Ayudante: Esto es la línea, con este se muerde es un morceto por fase y por neutro.    
    
---    
    
###### Nota personal.    
Son dos morcetos uno para la fase y otro para el neutro, nosotros.     
Hay unos antirobos que en el morceto de la fase tiene un fusible.    
    
---    
    
Para que entiendan no se puede pelar el cable allá arriba entonces lo que se hace es a través de un elemento auxiliar que muerdan los 2 a la vez entonces transmiten la energía.    
Maru: Ah, ese abre la aislación cuando muerde?    
Profesor: claro tiene unos dientes que hace que penetre ahí     
Maru: No pueden pelarle     
Ayudante: Se puede no se debe porque he visto trabajando muchas personas lo hacen pero esto al cerrar con fuerza, estos dientes pinchan la aislación.    
**Sebastián: Una vez que muerdo ya no se puede volver a usar ¿? (Minuto 31:15)    
Profesor: Sí, no hay problema porque es un borde no más, si el agua se desliza no es que hace contacto con el otro.**     
Profesor: Acá encontró una página ...    
Torres: se llama **"entre cables" en Instagram**, claro porque yo quería ver como estaba el durlock ahí.    
Profesor: Otra cosa ahí justo mostró una boca directamente de alumbrado y **acuérdense que cuando uno está haciendo un cieloraso suspendido  aparecen los perfiles entonces reutilizamos en algunos casos los perfiles y esto va así, perfil con perfil se ata en un lado lo que sea o esto va arriba y se pone la boca abajo bien fija esto queda fijo y después se hace la uniones con otra boca o la bajada o lo que sea**.    
Maru: Eso es por afuera o sea así a la vista?    
Profesor: No no, en el cieloraso suspendido. Lo que ud. ve ahí la estructura es un perfil vió la estructura de un perfil con durlock o con el sistema de PVC el cielo raso entonces ahí lo que se hace normalmente se fija con distintos elementos que uno consigue ahí directamente para que quede fijo esto, eso no más para mostrarle que a veces donde conseguimos dice:    
    
¿Como fijamos la boca? Y saca 2 o 3 metros no le hace nada. Este me va a matar con el (tereré) vamos a aceptarle por las dudas.    
Torres: Se va engripado.    
Profesor: Dice que el arquitecto tiene una computadora y tiene un proyector chiquito, eso me va a prestar pero me parece que no va a venir.    
...
No hay que medir hay que poner un foco si es 100 vatios va a pasar medio amper, hay que poner mas, si el foco no prende bien la tierra es mala y un 100 vatios es medio amper.    
El multitester son más funciones para cargas más pequeñas, pero se usa mucho en electricidad multitester y pinza amperométrica.    
Gusstavo Barrientos: La pinza no se usa porque tiene la escala muy alta más para electricidad y después el multímetro es más para electrónica es más chiquito.    
Maru: (No sabe lo que es el multitester)    
Ayudante: El multitester es esto, multitester o tester.    
