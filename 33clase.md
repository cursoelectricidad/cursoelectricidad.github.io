...
* El **ITM** es un dispositivo de protección que **actúa ante sobrecargas (parte térmica)** y **cortocircuitos (parte magnética)**.

* La **parte térmica** funciona con un **par bimetálico**: dos metales con distinto coeficiente de dilatación que se deforman por el calor generado por la sobrecorriente. Esto abre el circuito. Al enfriarse, se restablece y puede reconectarse.

* La **parte magnética** actúa ante un cortocircuito generando un campo magnético (electroimán) que abre el circuito instantáneamente.

* También existe una forma de **accionamiento manual**.

---

#### **📏 Parámetros importantes en un ITM**

* **Corriente nominal (In):** corriente de trabajo del equipo.

* **Corriente de ruptura:** máxima corriente que puede interrumpir sin destruirse.

* **Categoría:** los ITM de **categoría 3** son de alta calidad (seguridad superior).

* **Curva de disparo (curva B, C, D):** determina en qué condiciones dispara el ITM.

---

#### **⚙️ Selección de ITM y conductores**

* La elección del ITM se hace considerando:

  * **Potencia del equipo (P)**

  * **Tensión (V)**

  * **Corriente nominal**: se calcula como `I = P / V` (Ley de Watt).

* Se selecciona el **ITM** en función de la **corriente nominal** y la **corriente máxima admisible del conductor**.

* Se usa una **tabla de secciones** para conocer la corriente que soporta un conductor según su área:

| Sección conductor | Corriente máxima | ITM sugerido |
| ----- | ----- | ----- |
| 1 mm² | Retorno | 6 A |
| 1.5 mm² | Iluminación | 10 A |
| 2.5 mm² | Tomas generales | 16 A |
| 4 mm² | Tomas especiales | 20-25 A |
| 6 mm² o más | Para mayor potencia o tramos largos |  |

*   
  Importante: **el ITM debe proteger al conductor más delgado** si se usan tramos mixtos.

---

#### **⚡ Casos prácticos y recomendaciones del profesor**

* **Duchas eléctricas**: suelen tener consumos de \~4500 W, se recomienda conductor de **4 mm²** y térmica de **20 A**.

* **Aires acondicionados**: siempre deben tener un **circuito independiente** con su propio ITM, directamente desde el tablero.

* En instalaciones escolares o grandes, se sugiere un **tablero exclusivo para aires acondicionados**.

* Por estética y para evitar cuestionamientos, a veces se usan conductores más gruesos visibles y se cambia a la sección correcta en una caja de paso.
...
* **Corriente de protección (I de protección):** debe estar entre la **corriente nominal del equipo** y la **corriente máxima del conductor**.

* **Caída de tensión máxima permitida:**

  * Instalaciones domiciliarias: **3%**

  * Instalaciones industriales: **hasta 5%**

* **Uso de pinza amperométrica**: permite verificar si la sección de conductor elegida es correcta en función del consumo real.

---

#### **📐 Instalaciones y planificación**

* Se debe saber interpretar el **esquema unifilar**, que muestra los símbolos eléctricos y conexiones.

* El **montador** debe saber:
...
* En obra, se delegan partes del trabajo a distintos obreros o ayudantes; el capataz coordina y supervisa.

---

#### **📋 Normativa y estándares**

* Las normas locales (**AEA**) se basan en estándares internacionales **IEC**.

* Equipos y materiales eléctricos tienen compatibilidad normativa global.

* La **corriente de ruptura del ITM** (por ejemplo, 3000 A, 4500 A, 6000 A) debe considerarse según el tipo de instalación y los riesgos esperados.

---

### **🎓 Preguntas típicas de examen**

* ¿Cómo funciona la parte térmica del ITM?

* ¿Cuál es la corriente nominal y cómo se calcula?

* ¿Cómo elegir correctamente el ITM para un determinado consumo?

* ¿Por qué debe protegerse el conductor más delgado?
...
1. La parte térmica actúa ante una sobrecarga de circuito.    
2. La parte magnética lo hace ante un cortocircuito.    
Profesor: Cuando se unen dos elementos de distinta polaridad produce un cortocircuito, ese cortocircuito produce una corriente muy grande que provoca a su vez el pase de la corriente por un bobinado a través de un sistema electroimán produce un movimiento, ese movimiento hace que se acople el interruptor termomagnético, pero eso es lo que trabaja, está calibrado para esas condiciones de cortocircuito.    
En el examen habrá una pregunta chiquita de esta fotocopia por eso estamos leyedno (Minuto 39)    
Esa regleta acuérdense que cada sección de conductor ahí aparece el diámetro, sección que corriente máxima tiene, y aparte aparece un ítem que dice fusible, en esa época se usaba fusible pero también comenzaron a aparecer los interruptores termomagnético, pero cuando dice fusible hace referencia al ITM.    
1mm^2, 1,5mm^2, 2,5 mm^2, 4mm^2 y 10mm^2 que son los más usados.    
Y aparecerá un ítem que dice que corriente máxima soporta, entonces aparecerá que corriente máxima soporta y ahí vamos a ver como se elige un ITM.    
Acuérdense 4 cosas fundamentales: corriente, tensión, resistencia y potencia.    
Ayudante: El foco tiene, todos los renglones que nadie quiere leer, ahí está todas las especificaciones: la resistencia, potencia, consumo y los lúmenes.    
Profesor: Bueno, entonces esta I de protección, que es para interruptor tiene que ser mayor y tiene que ser menor que algo...     
Corriente nominal es la corriente de trabajo (funcionamiento) del equipo.    
Cualquier equipo aparecerá o la potencia o la corriente, si aparece la potencia pueden sacar el valor con la Ley de Ohm o Ley de Watt, la Lay de Ohm a veces no ocupamos porque tenemos que saber la resistencia y hay equipos que no tienen valor de resistencia especificada, entonces aparece la potencia y esto da... Esta es la unidad.    
Qué habíamos dicho? `P=VxI` (potencia es igual a tensión por corriente).    
El otro es la Ley de Ohm pero acá me interesa que ustedes saquen esta potencia, es igual a tensión por corriente. Esto si yo tengo corriente continua y si tengo alterna, estamos hablando en sistema monofásico, después vamos a hacer trifásico fórmula adecuada alterna. Y ese coseno de fi es una variable que tiende siempre a 1 cuanto más cerca llegue a 1, es mejor toda la potencia que entra, se convierte en potencia útil.    
Para un cálculo más rápido desaparece el 1 porque el coseno de fi será igual a 1, y con esto me permite hallar cualquier valor de corriente, conociendo la potencia y la tensión.    
Profesor: Esto vendría a ser la corriente nominal que sería esta: cuando yo saco la potencia `I=P/V` esto dará en amper, esta corriente será esta. Entenden?    
Watts sobre voltios me da amper.    
Profesor: Ejemplo: tu calefón, ducha eléctrica tiene consumo normal de 4500 watts de potencia.    
El consumo es lo que hace que sea el valor real que necesito para proteger y qué conductor voy a poner.    
Ducha eléctrica cambia valores de consumo dependiendo de si es tibio o caliente.    
En la ducha a veces aparece: ponga conductor de 4m^2 y si va a colocar una térmica en algunos casos hay que poner 25 amper pero yo prefiero poner de 20 amper en ese caso.    
Ahí dice 4 mm^2 perfecto, colocamos la corriente máxima en este caso será Imáximo fíjense que es de 24 amper y dijimos que I es protección o I del interruptor termomagnético está en término medio, entonces ese valor será igual a la térmica de 20 amper.    
...
un aire acondicionado a un equipo de una instalación existente requiere otra forma de proceder, **tengo que tener una idea de qué equipo colocar, qué conductor voy a colocar y que tablero voy a hacer: hago un tablero independiente directamente**     
...
Por tener tanta potencia reactiva por eso se trata que el coseno tienda a 1 no es igual a 1 pero tiende a 1.    
...
Hasta ahí sacamos la corriente o corriente nominal se calcula diviendo potencia dividido tensión o diferencia de potencial da en amperes.    
...
Pregunten, hay que despejar la `I` y esto "pasa" al otro miembro entonces directamente saco la corriente.    
