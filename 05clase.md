...
### **1\. Introducción a los símbolos eléctricos**
...
### **2\. Canalización: reglas y práctica**
...
### **3\. Riesgos de interferencias entre instalaciones**
...
### **5\. Cálculo de iluminación y distribución**
...
### **6\. Importancia de la interpretación del plano**
...
### **1\. Simbología de bocas de iluminación**
...
### **2\. Tipos de cajas ortogonales y su uso**

* **Caja ortogonal grande**:

  * Se utiliza como **caja de distribución** cuando se derivan varios circuitos en diferentes direcciones.
...
### **3\. Consideraciones en montaje y seguridad**
...
### **5\. Cañerías y compatibilidad con gancho U**
...
### **6\. Simbología de llaves eléctricas**
...
* Importante:
  ...
  * Cuando se ve una llave en el plano, significa que corresponde colocar **una caja rectangular 5x10 cm**.

---

### **7\. Procedimiento previo a la instalación**

* Antes de instalar:

  1. **Leer el plano y reconocer los símbolos.**

  2. **Hacer la lista de materiales** en función de la simbología.

  3. **Verificar qué cajas corresponden** (rectangulares u ortogonales).

  4. **Planificar la canalización** respetando normas y seguridad.
...
### **1\. Altura reglamentaria de cajas eléctricas**
...
### **3\. Fijación de ventiladores y cielorrasos**
...
### **4\. Ubicación de llaves e interruptores**
...
### **5\. Intervención del electricista en la obra**
...
### **6\. Consideraciones para canalización en paredes delicadas**
...
### **7\. Otros consejos útiles del profesor**
...
### **🛠️ Clase sobre Cajas de Derivación, Alturas, Cañerías y Trazado de Canalizaciones**

#### **📐 Alturas normalizadas de equipos**
...
#### **📦 Seguridad y ubicación de cajas**
...
### **🚧 Cañerías: Tipos, dimensiones y accesorios**

#### **📏 Medidas y equivalencias comunes**
...
* En planos, las **líneas rectas o curvas representan cañerías**, y se indica el tipo/diámetro arriba:
  ...
  * Ej: `RL 19 / 17` significa **caño de hierro liviano 19 mm ext. / 17 mm int.**

* Existen tres tipos de cañerías de hierro:
...
#### **📄 Bosquejo y lista de materiales**
...
### **📐 Simbología y lectura de planos sobre cañerías**
...
* Ejemplo:
  ...
  * **RS 19/16** → Caño semipesado con diámetro exterior 19 mm e interior 16 mm.
...
### **🔌 Conductores eléctricos: cantidad y sección**
...
* El cálculo de la sección es geométrico, usando la fórmula del área del círculo:  
   A=π×r2A \= \\pi \\times r^2
...
### **🛠️ Cañerías rígidas y corrugadas**
...
### **⚠️ Instalación correcta del corrugado**
...
### **💰 Costo y ventajas del corrugado**
...
### **🔥 Normativa sobre ocupación dentro de cañerías**
...
### **⚠️ Recableado en cañerías antiguas (plomo, hierro viejo, etc.)**
...
### **🔥 Ejemplo práctico de falla grave**
...
### **🧊 Cañerías y conductores para equipos especiales (ej. aires acondicionados)**
...
### **⚡ Efecto del capacitor de arranque en motores monofásicos**
...
## **Resumen de mensaje final y reflexión sobre la reglamentación y práctica**

### **🔑 La importancia de respetar la reglamentación**
...
### **😂 Anécdotas y humor para recordar conceptos**
...
![](https://acdn-us.mitiendanube.com/stores/001/660/566/products/2-51-22e506ff43c9c3f9d516668925819831-240-0.jpg)
...
Esto que está acá es una instalación que proyecta los materiales que ellos utilizan normalmente PVC.
...
Acá puede haber una variación, el split entonces generalmente se pone a una altura que rondar normalizado a 220 con respecto a nivel de piso, antes los de ventana se ponían a un 170, pero bueno eso va cambiando de acuedo al criterio que tenga el arquitecto, por más que queramos hacer, el que proyecta la casa es el arquitecto, que tiene una locura de hacer algo distintos.
...
Una vez que tenemos esto, ¿qué falta? 
Alumno: Conductores?    
...
Profesor: Esto tiene un pequeño problema: vos encendes y se enciende cuando se expande el fuego y es tóxico. Entonces no es ignífugo ... Este es ignífugo pero el otro no.
