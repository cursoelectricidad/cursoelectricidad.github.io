% Clase Nº 55: Repaso de colocación de cajas. Altura cajas. Anecdota: obrero unió 2 caños de hierro con corrugado. Ejercicio: Cálculo de materiales de un aula.
% Andrés Imlauer
% 12 Agosto 2025
...
![](https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEi7aS4fAo1V5r2PDv-7h6ghf0EqAqzI7JEkUhjbMfIyo5AvDsTTp9LPbY0CmimEdTKgQFvaqEuq-7kOMkzd6xOG7Y8DcTVvxrfc72jFsOjqtisoMmeTZLF-OJ7nKmalg7ytZK_f8Sn-8pD3et8MqM6uuUhYq8cmhUq42zNl0lApW4eLihiwBemnWiAeZQY/s4160/IMG_20250814_081452245.jpg)
...
* **Altura en garajes y zonas de acceso vehicular**:
  ...
  * Deben colocarse **a 1,50 m o más** para evitar interferencia con la apertura de puertas de autos y permitir conectar herramientas como aspiradoras.
...
* **Reglamentación de canalizaciones:**
  ...
  * Tanto **a la vista como embutidas** deben **respetar la ortogonalidad** del ambiente: **tramos verticales y horizontales**, paralelos a aristas/paredes. Evitar atajos en diagonal o trazas irregulares.
...
* **Detalles constructivos**
  ...
  * Altura de algunos elementos: ventilador a 2,10 m, con 30 cm de separación en un lado y espacio previsto para el pizarrón.
...
### Puntos Principales de la Clase de Electricidad
...
#### 1. **Colocación de Dispositivos de Control e Iluminación**
   - En edificios con ascensores: El interruptor o detector de movimiento para iluminación debe estar a menos de 2 m de las puertas del ascensor para facilitar el encendido al salir.
   - Cajas de interruptores: Deben colocarse a 15 cm (0.15 m) del marco de la puerta. Altura recomendada: 1.10 m desde el piso, con un rango permitido de 0.90 m a 1.30 m. Usar un punto de referencia imaginario (eje) para medir, y mantener uniformidad en toda la obra (ej. siempre a 1.10 m para evitar variaciones).
   - Razón: Facilita la instalación nivelada y evita errores en obras grandes.


#### 2. **Colocación de Tomacorrientes (Outlets)**
   - Orientación: Siempre en posición horizontal para unificar criterios y facilitar el trabajo si cambia el instalador (evita confusiones si se pierde el plano).
   - Alturas generales: Mayor a 0.15 m y menor a 0.90 m desde el piso. Recomendado: 0.40 m en viviendas para uniformidad. En mesadas: 0.15 m arriba de la superficie.
   - En garajes o zonas vehiculares: Mínimo 1.50 m de altura para evitar daños por vehículos o aspiradoras, y permitir apertura de puertas.
   - Para artefactos especiales (ej. TV): Hasta 1.50 m o más, dependiendo del tamaño (ej. TVs de 60-70 pulgadas).
   - Razón para altura mínima (0.15 m): Evitar contacto con agua durante limpieza (el agua es conductora y puede causar cortocircuitos o fugas).


#### 3. **Normas de Canalización y Materiales**
   - Recorridos: Deben ser ortogonales (líneas horizontales y verticales paralelas a las paredes), sin diagonales para ahorrar material y facilitar inspecciones. Evitar trayectorias cortas improvisadas que violen la norma.
   - Materiales: Usar el mismo tipo de cañería (ej. hierro o PVC) en cada sección hasta una caja de paso o boca. No mezclar materiales en curvas o tramos intermedios (ej. no unir hierro con PVC corrugado). Cambios solo en cajas.
   - Profundidades y especificaciones: Detalladas en planos, incluyendo conductores subterráneos (enterrados o con cañería), cámaras de inspección (con tapas dobles para protección) y profundidades según norma.
   - Ejemplos comunes: Cañerías de 3/4" (15.4 mm interno) para secciones mínimas; 7/8" para tramos con más cables (ej. 2x2.5 mm² + tierra).


#### 4. **Lectura de Planos y Simbología**
   - Símbolos clave:
     - Tomacorriente: Media curva con tres patitas (fase, neutro, tierra). Si indica "x2", son dos módulos en una caja de 10x5 cm.
     - Interruptor: Línea con punto o llave. Si hay dos cajas separadas, indican cañerías independientes.
     - Ventiladores o iluminación: Representados con paletas o círculos; reguladores a 1.50-2.10 m para evitar acceso de niños.
     - Cajas de paso: Cuadradas (ej. 10x10 cm).
   - Planos eléctricos: Deben incluir detalles completos (conductores, protecciones, puestas a tierra, materiales). En obras grandes, acompañados de pliego de especificaciones técnicas.
   - Cálculo de materiales: Dividir en tramos (segmentos numerados), medir con escala (ej. 1:50 o 1:100), contar cañerías, conectores, curvas, cables (ej. 3x1.5 mm² para iluminación). Agregar bastidores, módulos, tapas y portafocos.
   - Escala práctica: Si es 1:50, usar escalímetro; si no, aproximar a 1:100 con regla normal para simplificar mediciones.


#### 5. **Tableros y Protecciones**
   - Selección: Basada en módulos bipolares (2 por circuito). Ej. 4 circuitos = 8 módulos mínimo; agregar 20% extra (ej. tablero de 10-12 módulos) para espacio de conexión.
   - Diagrama unifilar: Muestra interruptor principal, diferencial y térmicas. Ubicación: Espacio adecuado según norma.
   - Máximo por circuito: Ej. 2 tomas por caja en algunos casos.


#### 6. **Prácticas Generales y Consejos**
   - Uniformidad: Mantener alturas y materiales consistentes en toda la instalación para estética y funcionalidad.
   - Inspección: Verificar planos detallados para evitar improvisaciones. En obras, marcar referencias con tiza o nivel.
   - Errores comunes: Mezcla de materiales, diagonales en canalización, alturas incorrectas (causan problemas con agua o accesibilidad).
   - Lista de materiales: Incluir unidades (metros para cañerías, unidades para módulos). Pedir completos (ej. "módulo completo con bastidor y tapa") para simplificar.
   - Vocación y aprendizaje: Empezar con tramos simples, practicar en planos pequeños (ej. un aula), ser sincero sobre dificultades para ajustar enseñanza.
...
https://www.youtube.com/watch?v=oqx2HhKvYQY

#### Transcripción

Vamos a terminar esta parte por lo menos para que entiendan dijo. Dice dentro de un inmueble existe 1 o 2 o más ascensores se debería situar el dispositivo de comando de iluminación a menos de 2 metros luego de la puerta del ascensor.
