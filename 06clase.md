% Clase Nº 6: Capacitación en Trabajo en Altura. Simbología. Instalaciones Eléctricas: Conceptos básicos. Anédocta: El ayudante de Alejandro Ramirez trabajando con tensión corta un cable (fase y neutro juntos) y provoca un cortocircuito que arruina su alicate y casi se muere.
% Andrés Imlauer
% 26 Marzo 2025
...
### **Seguridad y práctica en instalaciones eléctricas: aspectos clave y simbología básica**

* La seguridad en altura y el uso correcto de escaleras son fundamentales para evitar accidentes laborales. Se debe prever todos los riesgos y garantizar que la persona asignada a la tarea no esté en peligro.

* Ejemplos reales muestran accidentes por falta de planificación, como caídas desde escaleras por no observar cables de alta tensión, que pueden provocar lesiones graves incluso sin electrocución directa.

* La planificación del trabajo, la elección adecuada de herramientas y materiales, y no actuar con apuro son elementos clave para un trabajo seguro y exitoso.

* Se finaliza la etapa teórica con el estudio de simbología eléctrica, base para interpretar esquemas y planos.

* Se enfatiza que la práctica es fundamental para desarrollar confianza en tareas como desarmar cajas, cambiar tableros o térmicas.

* La simbología eléctrica básica incluye el reconocimiento de "bocas" (puntos de salida para tomas o interruptores) representadas por círculos o cajas ortogonales, con especificaciones de tipo de canalización (PVC o hierro).

* En instalaciones con cañerías de hierro, se recomienda que todo sea del mismo material para evitar problemas.

* La experiencia práctica permite identificar detalles como conectores y bordes filosos en cañerías que pueden causar cortes.

* Se explica el uso correcto de la sierra para cortar caños de hierro: debe usarse impulsando hacia adelante para evitar rebabas.

* Las rebabas se deben eliminar con pinzas para evitar accidentes y asegurar un buen acabado.

* En caños de PVC, aunque más blando, también se debe cuidar la aislación del cable para no dañarla al pasar los conductores, y se pueden usar sierras o tijeras especiales para corte.

* Preferencias personales en materiales pueden basarse en la experiencia y las propiedades del material, destacando el hierro como noble y rígido para instalaciones.

---

¿Quieres que te prepare un resumen aún más breve o una guía rápida con estos conceptos?

Perfecto, aquí tienes un resumen con los puntos más importantes, sin nombres, y un título adecuado para esta segunda parte de la transcripción:

---

### **Diferencias y cuidados en cañerías eléctricas: hierro vs PVC y mediciones básicas**

* El hierro es considerado un metal noble, rígido y con buena resistencia para canalizaciones; permite embutir cables pero puede ser más difícil introducirlos en ciertos casos.

* Las cañerías de hierro vienen en tres tipos: liviano, pesado y semipesado, con diferentes rigideces y necesidades de sujeción.

* Por ser rígido, el hierro requiere menos grapas o sujeciones en comparación con PVC, que por efectos de calor necesita más puntos de fijación.

* Las uniones eléctricas nunca deben hacerse dentro de los caños, sino siempre en cajas de paso o derivación para evitar problemas de seguridad.

* Aunque algunas personas aseguran que el PVC transmite corriente, si la instalación está bien protegida con interruptores y tableros adecuados, esto no representa un peligro.

* PVC es aislante y existen variedades con diferentes resistencias a la temperatura: hasta 60°C y versiones mejoradas hasta 90°C que no se deforman con calor moderado o fuego indirecto.

* PVC es más liviano y fácil de transportar, pero más caro; el hierro requiere mezcla mortero (cemento y arena, sin cal) para la fijación, ya que la cal puede corroer el hierro.

* Hay instalaciones con cañerías de hierro en excelente estado después de décadas, demostrando su durabilidad.

* El multímetro o tester es una herramienta clave para verificar la instalación antes de energizar, especialmente para detectar posibles cortocircuitos o contactos indebidos entre cables.

* Se debe medir continuidad entre fase y neutro en el tablero antes de poner en marcha la instalación, evitando explosiones o daños.

* El instrumento de medición muestra resistencia (en ohmios, símbolo Ω), permitiendo detectar si hay problemas eléctricos o continuidad no deseada.

---

¿Quieres que te prepare también una explicación práctica para usar el multímetro en estas pruebas o alguna guía paso a paso?

Claro, aquí te dejo un resumen con los puntos más importantes y un título para esta parte de la transcripción, sin nombres propios:

---

### **Instalaciones eléctricas: uso del multímetro, simbología y normas para circuitos de iluminación y tomacorrientes**

* La resistencia eléctrica se mide en ohmios (Ω), y el multímetro permite detectar continuidad auditiva para comprobar si dos cables están en contacto (ruido indica continuidad).

* Es fundamental usar herramientas disponibles para verificar la instalación antes de energizarla, evitando cortocircuitos o accidentes.

* El multímetro ayuda a detectar cables cortados o conexiones erróneas midiendo continuidad entre fase y neutro.

* Por convención, el conductor azul es neutro, y los conductores negro, marrón o rojo son fase (vivo).

* En instalaciones, el portalámparas es un punto común de problemas y cortocircuitos, por lo que debe instalarse y probarse correctamente; nunca dejar cables colgados sin conectar.

* En esquemas eléctricos, las "bocas" o puntos de salida para iluminación o tomacorrientes están representados con símbolos y deben corresponder a cajas específicas (ej. caja rectangular 5x10).

* Los circuitos de tomacorrientes y de iluminación deben ser independientes, con circuitos bipolares desde el tablero (fase, neutro y tierra).

* En baños o cocinas puede haber combinación de toma y llave de 1 punto en la misma caja, pero es una excepción.

* Todos los tomacorrientes y enchufes deben tener conductores de sección mínima 2,5 mm², mientras que la iluminación utiliza conductores de 1,5 mm².

* En cajas con tomacorriente y llave de 1 punto, se usa el conductor de mayor sección (2,5 mm²) para alimentación, y de menor sección (1,5 mm²) para iluminación.

* El interruptor termomagnético debe proteger el conductor de menor sección en el circuito (ej. 2x10 amper).

* No se recomienda ni permite poner dos circuitos independientes (iluminación y tomacorrientes) dentro de la misma caja.

* Se mencionan casos y ejemplos de instalaciones mixtas y normas que regulan estas prácticas.

* Se destaca la importancia de interpretar bien los planos y la simbología para evitar errores y cumplir con las normas vigentes.

* El espacio disponible en cañerías (por ejemplo, 35 mm²) y el espacio libre para disipar calor son factores técnicos importantes a considerar en la instalación.

---

¿Quieres que te prepare un esquema o un dibujo que ayude a visualizar estos conceptos?

Claro, aquí tienes un resumen con los puntos clave y un título para esta sección de la transcripción, sin nombres:

---

### **Organización y normativa en la instalación eléctrica: módulos, alturas y planificación**

* En una caja para interruptores (cajita), el espacio del medio no está reservado ni se deja libre necesariamente; puede ocuparse para instalar hasta tres módulos, por ejemplo varias llaves de punto.

* En baños amplios, es común distribuir diferentes puntos para manejo independiente de ducha, espejo o lavatorio, facilitando su control sin interferencia.

* El conductor de alimentación llega con sección 2,5 mm² y luego se reduce a 1,5 mm² para el retorno hacia la lámpara, que es la fase que corta la llave; el neutro permanece fijo en la caja.

* Las lámparas funcionan con 220 V en instalaciones domiciliarias de corriente alterna.

* Para medir y colocar cajas, se toma como referencia el nivel del piso, no el cielo raso, porque el piso es una base fija y más fácil de medir y controlar en obra.

* Alturas comunes para colocar cajas de toma o interruptores son 1,20 m y 0,40 m desde el nivel del piso, según la función y el diseño del proyecto.

* El arquitecto define la altura a respetar según el diseño de la obra y normativas.

* En la caja puede haber combinación de toma y llave de 1 punto, pero la cantidad máxima recomendada de módulos instalados en una caja suele ser dos para evitar problemas de conexión o espacio.

* En algunos casos se ven cajas con tres módulos, pero esto no es adecuado por dificultades en conexiones y espacio.

* La planificación comienza siempre con la canalización, que debe hacerse antes de instalar cables o artefactos.

* Existen otros tipos de bocas en proyectos eléctricos, como para teléfono o internet, aunque no siempre se utilizan.

* La simbología en planos eléctricos incluye esos detalles para identificar qué y dónde se debe instalar.

---

¿Quieres que te haga un esquema con medidas estándar para la instalación de cajas e interruptores?

Claro, aquí tienes un resumen claro con los puntos más importantes y un título para esta última parte de la transcripción, sin nombres:

---

### **Capacitación en seguridad y correcta instalación de tomacorrientes: normas y buenas prácticas**

* Se ofrece invitación para participar en un curso sobre trabajo en altura, con participación de autoridades de seguridad laboral, ART y otros organismos, recomendando aprovechar estas capacitaciones.

* En la instalación de tomacorrientes, cada módulo estándar soporta hasta 10 amperios, mientras que un conductor de 2,5 mm² soporta hasta 18 amperios.

* Es común encontrar tomacorrientes con terminales invertidas; la unión o puentear debe hacerse respetando fase con fase y neutro con neutro, sin cruzar cables.

* En la práctica, el primer tomacorriente conectado puede sufrir la suma de corrientes de todos los aparatos conectados en serie, lo que puede provocar que el módulo se dañe por sobrecarga.

* La norma indica que la corriente debe ser soportada por el conductor (cable) y no por el módulo; por eso es fundamental hacer las uniones correctamente y evitar que los módulos soporten corrientes mayores a las permitidas.

* En la caja de tomacorrientes debe dejarse un "bucle" de cable para facilitar las uniones y evitar tensiones o conexiones apretadas que dificulten la instalación y mantenimiento.

* La unión de cables debe hacerse directamente entre conductores, no entre módulos ni con cruces inapropiadas.

* Se enfatiza la inspección y revisión rigurosa de las instalaciones para asegurar que cumplan con las normas y evitar errores comunes que pueden causar fallas o riesgos.

* La formación práctica y supervisión son claves para asegurar instalaciones seguras y duraderas.

---

¿Quieres que te ayude a preparar una guía rápida o checklist para la correcta instalación y revisión de tomacorrientes?

Aquí tienes un resumen con los puntos más importantes y un título para esta última parte de la transcripción, sin nombres:

---

### **Instalación y conexiones en tomacorrientes y timbres: conceptos prácticos y seguridad**

* En una cañería que alimenta dos tomacorrientes, solo baja un cable de 2,5 mm² y las uniones se hacen dentro de la caja correspondiente, no se envían cables separados para cada toma.

* Las uniones dentro de la caja deben hacerse correctamente, uniendo cables y no saltando o haciendo conexiones inapropiadas entre módulos, para evitar recalentamientos y riesgos.

* Para pelar cables se puede usar una trincheta o herramienta adecuada, que será explicada en la práctica.

* El timbre eléctrico funciona con un transformador que baja la tensión de 220 V a 24 V para seguridad.

* Una tensión de 24 V produce una corriente de aproximadamente 30 mA, que genera solo un cosquilleo y no es peligroso para las personas.

* Se recomienda que los timbres estén ubicados en lugares que no permitan el ingreso directo a la vivienda para proteger la privacidad y seguridad.

* Se mencionan aspectos prácticos de organización del curso, inscripción, listas de asistencia y comunicación por WhatsApp para información exclusiva.

* Se prepara el inicio de la práctica con entrega de herramientas y materiales para que los alumnos comiencen a trabajar.

---

¿Quieres que te prepare un esquema o guía rápida para la correcta conexión de tomacorrientes y timbres?

Aquí tienes el resumen con puntos destacados y un título, sin nombres:

---

### **Preparación y organización de la práctica con tableros y herramientas en instalación eléctrica**

* Se comenzará desarmando tableros (bastidores) para limpiar y preparar un banco de pruebas para ejercicios prácticos.

* Se contará la cantidad de tableros disponibles para asignar uno por grupo o mesa, de modo que cada alumno pueda practicar armado y cableado.

* Se planifica armar portalámparas para practicar instalaciones reales y conocer la manipulación correcta de materiales.

* Se hará la canalización, conexión con conectores y armado de circuitos básicos para fortalecer el aprendizaje práctico.

* Se disponen alicates con aislación para tensiones hasta 1000 V, garantizando seguridad durante el trabajo eléctrico.

* Se recomienda cuidar las herramientas, evitando dejarlas en lugares expuestos al sol para no dañar la aislación, lo cual compromete la seguridad.

* Consulta sobre normas IRAM en Paraguay: solo aplica en Argentina. Se recomienda verificar que las herramientas que se compren cumplan con las especificaciones técnicas necesarias, independientemente del país.

* Se hace énfasis en la importancia de trabajar con herramientas confiables y seguras, sin importar la procedencia.

---

¿Quieres que prepare una lista de herramientas básicas recomendadas para estas prácticas?

Claro, aquí te dejo un resumen ordenado con los puntos clave sobre seguridad y manejo de herramientas en trabajo eléctrico:

---

### **Seguridad y manejo de herramientas en instalaciones eléctricas**

* **Nunca trabajar con tensión sin necesidad:**  
   Siempre que se pueda, bajar la energía antes de empezar cualquier trabajo eléctrico.  
   Revisar y diagnosticar con la energía baja para evitar riesgos.

* **Trabajo con tensión solo si es imprescindible:**  
   En esos casos, se debe usar equipo de protección personal adecuado:

  * Guantes aislantes (de goma o materiales certificados).

  * Botines con suela aislante y diseño eléctrico, que eviten que la corriente pase al cuerpo.

* **Herramientas:**

  * Es fundamental que tengan mangos aislantes, preferiblemente certificados para la tensión que se va a manejar (por ejemplo, hasta 1000 V).

  * Algunos alicates antiguamente usaban una manguera como aislante, pero hoy en día se usan materiales específicos y más seguros.

  * Al comprar herramientas, buscar aquellas con certificaciones reconocidas, independientemente de la procedencia (china, americana, etc.).

  * El alicate es la herramienta básica para corte, trabaja como una tijera y algunos modelos tienen resorte para facilitar el uso.

  * Cuidado con perder piezas como resortes, ya que afectan la funcionalidad de la herramienta.

* **Manejo del alicate:**

  * Se usa como tijera: marcar el cable y luego hacer palanca para cortar con precisión.

  * Es preferible tener un alicate con resorte para facilitar la apertura y cierre.

* **Importancia de la seguridad:**

  * Siempre se debe priorizar la seguridad personal y de terceros.

  * Usar herramientas adecuadas y mantenerlas en buen estado para evitar accidentes.

  * Evitar improvisaciones o uso de herramientas o elementos que no estén diseñados para trabajo eléctrico.

---

¿Querés que te ayude a armar un checklist de seguridad para que lo uses en obra o en capacitación?

Perfecto, te armo un resumen con los conceptos y consejos clave para pelar cables y hacer empalmes correctamente, usando alicate y pelacables:

---

### **Cómo pelar cables y hacer empalmes en instalaciones eléctricas**

#### **Pelar cables con alicate**

* Para principiantes, lo ideal no es hacer fuerza bruta ni tratar de pelar con el alicate directamente, porque puede dañar el cable o lastimar la mano.

* El método correcto:

  1. Sujetar el cable con la pinza (o con la mano firme).

  2. Con el alicate, primero marcar la aislación haciendo un pequeño corte sin cortar el conductor.

  3. Hacer un giro o palanca con el alicate para abrir la aislación y despegarla.

  4. No usar el dedo para pelar, para evitar cortes o lastimaduras.

* Esta técnica permite pelar el cable sin dañarlo ni hacer fuerza excesiva.

#### **Pelar cables con pelacables**

* El pelacables es una herramienta específica para pelar cables, muy útil y rápida para secciones hasta 4 mm².

* Tiene distintos orificios (intersticios) para cada calibre de cable (1 mm², 1.5 mm², 2.5 mm², hasta 4 mm²).

* Para usarlo:

  1. Insertar el cable en el orificio correspondiente (o el anteúltimo para 2.5 mm²).

  2. Cerrar la herramienta para que corte la aislación sin dañar el conductor.

  3. Tirar o hacer un pequeño giro para retirar la aislación.

* El pelacables agiliza mucho el trabajo y evita dañar el conductor.

* Hay pelacables especializados, por ejemplo para terminales punta hueca, que no sirven para pelar cables comunes.

#### **Distancia y medida para pelar**

* La norma aconseja pelar aproximadamente entre 2 y 3 centímetros de aislación (equivalente a dos dedos).

* Para conductores de mayor sección (más gruesos), se recomienda pelar un poco más (3 cm) para facilitar el empalme.

* Esto asegura una buena conexión y evita problemas de contacto o que el empalme quede muy justo.

#### **Empalmes: Prolongación**

* Empalmar significa unir dos conductores del mismo calibre para prolongar el cableado.

* Primero pelar los cables con la distancia correcta.

* Hacer un buen contacto mecánico (torcido, prensado, o con conectores).

* Luego aislar correctamente con cinta aisladora, asegurándose que no queden partes expuestas.

#### **Medición y precisión**

* Con el tiempo es útil usar un calibre (pie de rey) para medir el diámetro del conductor y pelar la aislación de acuerdo a la norma (10 veces el diámetro, aunque en la práctica se usa entre 2 y 3 cm).

* Esto ayuda a estandarizar y evitar errores en el empalme.

---

¿Querés que te prepare un paso a paso visual o con imágenes para hacer el pelado y empalme? También puedo ayudarte con recomendaciones de qué pelacables comprar según tus necesidades.

Claro, te hago un resumen claro y ordenado para usar correctamente la **cinta aisladora** y te doy una explicación sencilla sobre el **protector de sobre y baja tensión** que mencionaste.

---

### **Cómo usar la cinta aisladora para empalmes eléctricos**

1. **Finalizado el empalme mecánico**, ya sea torcido, prensado o con conectores, se debe aislar correctamente para proteger la unión y evitar contacto eléctrico.

2. **Primera capa de cinta aisladora**:

   * Se utiliza para **mantener firme el empalme**, es decir, para que la unión no se desarme con el movimiento o vibración.

   * Se debe aplicar con firmeza, dando vueltas constantes alrededor del empalme, sin dejar espacios ni superponer demasiado la cinta.

   * No sirve hacer “eehe-eeeeh” o tironear la cinta sin control, porque la cinta es redonda y si no se aplica con cuidado puede quedar floja o cortarse con el tiempo.

3. **Segunda capa de cinta aisladora**:

   * Se aplica para **garantizar la aislación eléctrica y protección contra humedad, polvo y roce**.

   * También se debe aplicar con tensión constante y cubriendo bien toda la superficie expuesta.

4. **Importante**:

   * La cinta aisladora debe tener buena calidad y resistencia al envejecimiento y la intemperie.

   * No hay que confiar en cinta dañada, ni aplicar capas débiles que con el tiempo se desprendan.

---

### **Sobre herramientas para pelar cables y corte**

* Hay pelacables para diferentes calibres, algunos muy básicos y otros más profesionales.

* Se debe evitar usar herramientas baratas o inadecuadas porque dañan el conductor o no pelan bien.

* Es mejor invertir en herramientas con mango aislante y buena calidad, incluso si son un poco más caras.

---

### **Protector de sobre y baja tensión**

* Los dispositivos eléctricos en una casa normalmente trabajan a una tensión estable, por ejemplo 220V ± un rango pequeño (220 a 239V).

* **Sobretensión**: cuando el voltaje sube más de ese rango permitido, puede dañar aparatos eléctricos.

* **Baja tensión**: cuando el voltaje baja demasiado, también puede causar mal funcionamiento o daños.

* El **protector de sobre y baja tensión** es un dispositivo que:

  * Detecta si la tensión está fuera del rango seguro.

  * **Corta automáticamente la alimentación** para proteger los aparatos.

  * Puede ser rearmado manualmente si es necesario (por ejemplo, si está cortando constantemente, se puede desconectar momentáneamente).

* Muy útil en viviendas donde la tensión no es estable o hay variaciones frecuentes.

---

¿Querés que te prepare un esquema o dibujo para entender mejor cómo se coloca la cinta aisladora o cómo funciona el protector? ¿O que te pase referencias de marcas recomendadas para cinta y protectores?

Perfecto, te hago un resumen con los puntos clave que tocaste sobre protección de equipos eléctricos, bancos de capacitores y herramientas aislantes:

---

### **Estabilizadores, UPS y protectores de tensión**

* **Estabilizador:**  
   Sirve para regular pequeñas fluctuaciones de tensión, pero no protege ante cortes de energía o caídas muy bruscas. Por eso, **no es lo ideal para proteger una computadora**.

* **UPS (Sistema de alimentación ininterrumpida):**  
   Es la opción correcta para proteger equipos sensibles como computadoras. Además de estabilizar, provee energía temporal cuando hay corte.

* **Protectores de tensión para equipos específicos:**  
   Se pueden colocar **en el enchufe de cada equipo delicado**, como heladeras, televisores grandes, computadoras.  
   Estos dispositivos cortan la energía si la tensión se sale del rango seguro para evitar daños. Los modelos modernos son programables y tienen indicadores luminosos para mostrar baja o alta tensión.

---

### **Banco de capacitores y corrección del factor de potencia (coseno phi)**

* En industrias o comercios con **motores, resistencias y otros consumos inductivos**, se genera potencia reactiva que no es útil para trabajo pero "carga" la red eléctrica.

* **Banco de capacitores:**

  * Se instala junto al tablero principal para corregir el coseno phi (factor de potencia), mejorando la eficiencia del sistema.

  * Esto evita multas o penalizaciones por parte de la distribuidora eléctrica (como EMSA), que exige que el factor de potencia se mantenga cercano a 1 (idealmente entre 0,95 y 0,98).

  * El banco de capacitores reduce pérdidas y mejora la calidad de energía.

  * Por ejemplo, panaderías o comercios con hornos eléctricos suelen tener banco de capacitores.

---

### **Herramientas aislantes y seguridad**

* **Herramientas con aislación adecuada** (mango aislante certificado) permiten trabajar con seguridad en instalaciones eléctricas.

* Aun así, siempre hay que tener cuidado y no confiarse sólo por tener herramienta aislante.

* En algunos casos, no hay disponible destornilladores aislados, y hay que extremar las precauciones.

---

Si querés, puedo ayudarte con:

* Recomendaciones de marcas o modelos de UPS y protectores.

* Explicación más detallada con gráficos del banco de capacitores y coseno phi.

* Normativas sobre herramientas aislantes y su certificación.

¿Querés que te prepare algo de eso?

Excelente resumen y consejo práctico sobre herramientas, seguridad y técnicas para trabajar en electricidad. Te dejo un repaso y algunos puntos clave organizados para que quede claro:

---

### **Uso de herramientas aisladas y seguridad al trabajar con bornes de fase**

* **Destornillador aislado:**  
   Siempre usar destornilladores con mango aislado para evitar descargas eléctricas al ajustar bornes de fase.  
   Si la herramienta no está aislada y tocas un borne con tensión, recibirás una descarga.  
   En caso de duda, usar guantes aislantes además de herramientas aisladas.

* **Herramientas no aisladas \= peligro:**  
   No confíes en destornilladores o pinzas sin aislamiento. Siempre revisa que tengan certificación o estén diseñadas para trabajo eléctrico.

---

### **Alicate y pinzas: cuidado y uso adecuado**

* **Cortar cable, no alambre:**  
   El alicate debe usarse para cortar cables eléctricos, no alambres. Cortar alambre con alicate daña los filos, genera “dientes” y una mala herramienta.  
   Siempre revisa los filos del alicate mirando a contraluz: no debe haber espacios ni “luces” en las uniones.

* **Pinzas bien cerradas:**  
   Una buena pinza tiene los filos perfectamente cerrados y alineados. Esto garantiza corte limpio y durabilidad.

---

### **Herramientas dieléctricas (aisladas)**

* Los juegos de destornilladores y alicates aislados suelen ser más caros pero son necesarios para seguridad.

* En algunos lugares están muy caros, por eso hay que cuidar bien las herramientas.

* Ejemplo: una llave de punta aislada sirve para manipular circuitos en lugares estrechos sin tocar partes con tensión.

---

### **Técnica práctica para pelar cables y empalmes**

* Para empalmar, hay que pelar la aislación del cable hasta exponer el cobre.

* Se puede usar pinzas o alicates para hacer esta tarea, pero hay que dominar la herramienta para no dañar el conductor.

* La próxima clase incluirá la práctica de armar un portalámparas y realizar empalmes.

---

### **Tips y anécdotas**

* Si desarmás algo y no sabés cómo armarlo, fijate bien los tornillos y su ubicación para evitar problemas.

* No hay que sacar tornillos innecesarios.

* La paciencia y la observación son claves para el armado correcto.

---

¿Querés que te arme una guía para reconocer herramientas aisladas y cuidar el material o te ayudo con prácticas de empalmes y uso de portalámparas?

Perfecto, te hago un resumen ordenado y claro para la próxima clase sobre portalámparas y empalmes, incluyendo lo del “cola de rata”:

---

### **Próxima clase: armado de portalámparas**

* Cada alumno recibirá un portalámparas para armar y probar.

* Importancia de armarlo bien:

  * Que funcione correctamente.

  * Que la lámpara no gire dentro del portalámparas (para evitar entrecruzamiento y posibles cortocircuitos).

* Se reutilizarán materiales que ya tienen.

* Una vez armado y probado el portalámparas, pasarán al tablero para conectar y probar.

* Se utilizarán herramientas y equipos de prueba: buscapolos, lámpara de prueba, probador de tensión, multímetro para verificar continuidad y ausencia de cortos.

---

### **Práctica y aprendizaje**

* El profesor y ayudante supervisarán, darán indicaciones y consejos.

* Se busca que todos aprendan a revisar una instalación, hacer pruebas y detectar fallas.

---

### **Empalmes: foco en el “cola de rata”**

* **Empalme cola de rata:**

  * Se trenzan las puntas de los cables sin más protección ni soldadura.

  * Está prohibido en instalaciones normales porque es débil y poco seguro.

  * Solo se utiliza en casos de emergencia y generalmente trabajando con tensión.

* El ayudante mostró cómo se hace, es común pero no recomendable.

* Se elaborará un resumen con los tipos de empalmes más correctos y sus usos.

---

¿Querés que te prepare un esquema con tipos de empalmes recomendados y técnicas para portalámparas para que lleves a la clase? ¿O algún video corto para complementar?

¡Muy buen fragmento\! Te dejo un resumen ordenado con los puntos clave para que lo tengas a mano:

---

### **Trabajar con energía y uso de herramientas aisladas**

* **Si trabajo con energía (tensión) siempre usar pinza o herramienta aislada para manipular cables o empalmes.**

  * Se puede tocar la aislación sin problema, pero nunca el conductor.

  * La pinza permite sujetar sin riesgo si está bien aislada.

  * Usar destornillador aislado para ajustar bornes; los destornilladores sin aislación pueden provocar descargas.

* **Seguridad al manipular energía:**

  * No tocar partes metálicas o conductores vivos directamente.

  * Mantener concentración para evitar contacto accidental con otras partes metálicas (pared, techo, etc.) que pueden hacer de camino a tierra.

* Cada herramienta debe usarse correctamente para garantizar seguridad.

---

### **Empalmes sin tensión**

* Hay varias formas, pero una común y rápida:

  * Trenzar los cables en forma de "X" y luego unir un lado y después el otro.

  * La aislación debe cubrir todo el empalme, sin dejar filamentos al aire ni bultos.

  * Luego se debe envolver firmemente con cinta aisladora para proteger y fijar.

---

### **Cuidado con el soporte de lámparas**

* Los cables bipolares **no deben soportar el peso de la lámpara** ni ningún otro peso.

* En instalaciones industriales o con lámparas grandes se usan argollas, cadenas o cables específicos para soportar la carga.

* El conductor debe quedar libre de tensión mecánica para evitar daños o riesgos.

* En casos donde se usa cable tipo "taller" (cable con malla de acero para soporte) debe ser solo para soporte, no para corriente directamente.

---

### **Mantenimiento de herramientas**

* El alicate y otras herramientas pierden filo y calidad con el uso.

* Intentar afilar puede no ser sencillo por el ángulo y tratamiento del acero.

* Se recomienda cuidar las herramientas para alargar su vida útil.

---

Si querés puedo ayudarte a preparar ejercicios prácticos o checklist para que los alumnos recuerden todos estos puntos al armar y manipular empalmes, portalámparas o al usar herramientas. ¿Querés?

¿O preferís que te haga una guía paso a paso para un empalme seguro?

¡Muy buen repaso\! Aquí te dejo un resumen ordenado y claro de los puntos que mencionaste, para que quede todo bien registrado:

---

## **Uso adecuado de pinzas y tenazas para corte**

### **Diferencia entre alicate y tenaza para cortar cables/alambres**

* **Alicate:**

  * Tiene filo muy fino, ideal para cortar cables eléctricos y pelar cables.

  * No es apto para cortar alambres duros o cables gruesos.

  * Cortar alambres duros con alicate puede generar muescas o daños en el filo, lo que afecta su funcionamiento para cortar cables eléctricos.

* **Tenaza:**

  * Filo más grueso y resistente, diseñada para cortar alambres duros y gruesos.

  * Ideal para cortar alambres o conductores más resistentes sin dañar la herramienta.

---

### **Errores comunes y consecuencias**

* Cortar dos cables juntos (fase y neutro) con alicate o tenaza puede causar **cortocircuito** inmediato.

* Siempre cortar cables **de uno en uno**, incluso si vienen juntos (como cables tipo “taller” o multicables).

* Prestar herramientas a personas sin experiencia puede llevar a daños en las herramientas o accidentes.

---

### **Experiencia del ayudante “Carlos”**

* Prestó su alicate a alguien que cortó dos cables juntos.

* Resultado: cortocircuito, chispa, y daño en la herramienta.

* Aprendizaje:

  * No prestar herramientas, o asegurarse que quien las use sepa manipularlas.

  * Cada herramienta es personal, da confianza saber su estado y funcionamiento.

  * Mantener herramientas aceitada y en buen estado prolonga su vida útil.

---

### **Herramientas hidráulicas para empalmes grandes**

* Se usan para empalmar conductores grandes (16 mm², 25 mm²).

* Reducen esfuerzo porque aplican fuerza hidráulica.

* Importante usar la herramienta correcta para cada tipo de conductor (cobre o aluminio), para no dañarla.

---

¿Querés que te ayude a armar un protocolo o lista de recomendaciones para uso y cuidado de herramientas eléctricas? Así podés compartirlo con los alumnos para evitar estos errores comunes.

¡Muy buen cierre para la clase\! Aquí te dejo un resumen claro sobre el uso del multímetro y la importancia del cuidado de las herramientas, que podés guardar o compartir con tus alumnos:

---

## **Uso y cuidado del multímetro (tester)**

* Los **multímetros** o testers tienen **fusibles internos** que protegen el equipo si se usa incorrectamente (por ejemplo, al medir corriente en un rango inadecuado).

* Algunos testers baratos o de baja calidad **no tienen fusibles**, lo que puede dañarlos irreparablemente si se usan mal.

* Siempre **graduar correctamente el multímetro** antes de medir (voltaje, corriente, resistencia, etc.) y elegir el rango adecuado.

* Evitar golpes, caídas o maltrato físico para que la pantalla y las funciones sigan funcionando bien.

* Las herramientas buenas suelen ser caras (más de 100.000 pesos) pero duran más y dan confianza.

* **No prestar herramientas**, para evitar mal uso y daño.

* La calidad de la medición depende no solo del equipo sino también de **quién lo usa y cómo**.

* Una herramienta puede ser excelente, pero mal utilizada se puede romper o dar resultados erróneos.

---

**Consejo final:** La formación y práctica en el uso de instrumentos es tan importante como la calidad de las herramientas. La confianza en el equipo es fundamental para diagnosticar y reparar instalaciones eléctricas con seguridad y eficacia.



---
title: "Curso Electricidad / Clase 5: Capacitación trabajo en altura. Último día de simbología. Bastidores. Conductores practicar empalme, desarmar cajita cambiar tablero. Repaso clase anterior. PVC o de hierro. Con que corrugado de hierro. Mezcla mortero. Cal corroge al hierro. Medir continuidad. No debe haber continuidad en borneras(tornillos) bajo térmicas. Portalámparas para probar instalación. Antes se mezclaba luces con tomas. Todo enchufe va con sección 2,5 mm^2. Iluminación es de sección 1,5mm^2. Tengo que llegar a 2,5. Fase a la derecha. ITM=2x10A protejo el conductor más chico. No se puede poner 2 circuitos en la misma caja. 35% del espacio se puede ocupar el resto libre por el efecto yull. Antes estructura y cieloraso ya debería estar la instalación eléctrica hecha. Cálculo nivel con infrarojo. No se puede colocar 3 módulos. Lo primero es la canalización. Boca de teléfono ya no se usa. Pregunta alumno: tomacorriente se cruza? No, se usan más cables sino sobrecarga un módulo. Bucle: lugar para meter la mano. En el aula hay un transformador entra 220 y sale 24 voltios para el timbre. Empalme prolongación. Empalme tipo cola de rata. Recomendación: cortar el cable de 1 a 1, sino hay riesgo de cortocircuito. Entonces vimos rápido acuérdense siempre ustedes cuando ven una boca ya sea círculo o círculo cerrado o una circunferencia eso es boca. Que se representa a través de una cajita ortogonal ya puede ser de PVC o la otra que es de hierro, siempre hay que tener en cuenta con que tipo de canalización se encuentra. El tema de seguridad: yo detecto con el dedo que conector que está y a su vez que cañería utilizo bueno eso ya es experiencia, uno de mis alumnos metió el dedo acá y giró al girar se encontró con este alambre y sangraba. Las cañerías de hierro yo tengo una sierra generalmente de 32 dientes y los dientes siempre están en forma de diente para adelante entonces el trabajo es para allá (para adelante) cada vez que yo impulso corto, pero como es una hoja de sierra. No tiene que haber rebarba en la parte de cañería de hierro."
date: 2025-03-26T01:42:30-03:00
tags: [electricidad]
---
#### Audio en Vocaroo:   
...
Alumno: Un transformador ya te tapa   
Profesor: NO. Te tapa o no podés colocar 3 módulos, 2 es aceptables pero 3 módulos, te voy a mostrar por qué les hice sacar la cajita por la forma de conectar y todo.   
